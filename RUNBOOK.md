...
*Frontend fix session 2026-05-26: AD-33 centralised document repository decision recorded; CI trigger extended to docs/** branches (PR #170); design standardisation pass A completed (PRs #171–#173); PROMPT_TEMPLATE.md created as new canonical document.*
...
*Last updated: Frontend Fix Session — 2026-05-26 (PRs #169–#173).*
