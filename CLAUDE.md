...
**Started:** May 2026
**Current state:** Sprint 16 complete — **Phase 5 (Quoting Module & Enforcement) Sprint 2 of 4**. Sprint 16 delivered the customer-facing quoting UX, PDF generation, and CSV export gap-closure. Frontend: new pages `QuoteForm.jsx` (3-section form with live 500ms-debounced preview matching engine logic exactly) and `QuoteDetail.jsx` (version browser, line-item table, status management, PDF buttons). `InternalDealDetail.jsx` now has a Quotes section with New Quote / View / Add Version modals; `DealDetail.jsx` (partner portal) gets a read-only `PortalQuoteSection`. Backend: migration 025 adds `pdf_artifact_data` (Text), `pdf_generated_at`, `pdf_filename` to `quote_versions`; new `reportlab==4.2.2` dependency renders a branded PDF (Fracttal blue header, line-item table, footer). Two new endpoints: `POST /quotes/{id}/versions/{n}/generate-pdf` (internal write roles) and `GET /quotes/{id}/versions/{n}/pdf` (partner_admin own + internal). PDFs are stored base64-encoded in the DB (**AD-19** — Railway's filesystem is ephemeral). Gap closure: 7 existing list endpoints now accept `?export=csv` (deals, internal deals, documents, internal partners, internal partner-users, applications, internal users) and 7 frontend pages get an Export CSV button using the fetch+Blob pattern (**AD-20** — authenticated downloads must send `Authorization`, so never `window.location.href`). New shared helper `backend/csv_export.py` centralises the CSV response shape. Sprint 16 fix version 10767 + native sprint 740 closed. Alembic head advances 024 -> 025. **~493+ backend tests passing** (Sprint 15 baseline 476 + 11 PDF + 7 CSV). Total API surface ~113 endpoints + 7 endpoints extended with `?export=csv`. Phase 5 epic FPRM-238 — Quoting Module & Enforcement. Sprint history in CLAUDE_HISTORY.md.
...
| Sprint IDs (native) | Sprint 1: `501`, Sprint 2: `534`, Sprint 3: `535`, Sprint 4: `536`, Sprint 5: `537`, Sprint 6: `538`, Sprint 7: `539`, Sprint 8: `572`, Sprint 9: `605`, Sprint 10: `638`, Sprint 11: `671`, Sprint 12: `704`, Sprint 13: `705`, Sprint 14: `706`, Sprint 15: `739`, Sprint 16: `740` |
| Sprint fix version IDs | Sprint 1: `10528`, Sprint 2: `10561`, Sprint 3: `10562`, Sprint 4: `10563`, Sprint 5: `10564`, Sprint 6: `10565`, Sprint 7: `10566`, Sprint 8: `10599`, Sprint 9: `10632`, Sprint 10: `10665`, Sprint 11: `10698`, Sprint 12: `10731`, Sprint 13: `10732`, Sprint 14: `10733`, Sprint 15: `10766`, Sprint 16: `10767` |
