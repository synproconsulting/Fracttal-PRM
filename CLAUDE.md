...
**Started:** May 2026
**Current state:** Sprint 12 complete — Phase 4 (Admin Foundation & Reporting) in progress. Sprint 12 delivered the internal user-management surface and the partners list page on top of Sprint 11's InternalLayout shell. New backend routers: `internal_users_router.py` (system_admin-only CRUD + invite + role/disable/reactivate, with new `User.last_login_at` populated by `auth_router.login`); `internal_partner_users_router.py` (cross-org partner-user admin for system_admin + channel_ops_admin); `internal_partners_router.py` (searchable/filterable `GET /internal/partners` for system_admin / channel_ops_admin / channel_manager). New frontend pages: `InternalUsers.jsx` at `/internal/users` (FPRM-198), `PartnerUserManagement.jsx` at `/internal/partner-users` (FPRM-202), `InternalPartnerList.jsx` at `/internal/partners` (FPRM-205) — Partners and Users nav items in InternalLayout flipped from `Coming soon` to live, Partner Users sub-nav added. Four bug fixes also landed in-sprint: dashboard/summary now accessible to internal admins (FPRM-190); `ApplicationStatus.in_review` renamed to `under_review` via migration 019 to align with the deal status vocabulary so `?status=under_review` returns 200 instead of 500 (FPRM-191/FPRM-192); InternalHome 'Open Conflicts' tile no longer leaks the raw `conflict_detected` string (FPRM-193). User schema gains `last_login_at` via migration 020. Sprint 12 fix version 10731 + native sprint 704 closed. 372 backend tests passing. Phase 4 epic FPRM-175. Sprint history in CLAUDE_HISTORY.md.
...
| Sprint IDs (native) | Sprint 1: `501`, Sprint 2: `534`, Sprint 3: `535`, Sprint 4: `536`, Sprint 5: `537`, Sprint 6: `538`, Sprint 7: `539`, Sprint 8: `572`, Sprint 9: `605`, Sprint 10: `638`, Sprint 11: `671`, Sprint 12: `704` |
| Sprint fix version IDs | Sprint 1: `10528`, Sprint 2: `10561`, Sprint 3: `10562`, Sprint 4: `10563`, Sprint 5: `10564`, Sprint 6: `10565`, Sprint 7: `10566`, Sprint 8: `10599`, Sprint 9: `10632`, Sprint 10: `10665`, Sprint 11: `10698`, Sprint 12: `10731` |
